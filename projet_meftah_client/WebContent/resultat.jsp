...
PreparedStatement st=con.prepareStatement("select * from livre where name LIKE '%"+name+"%'; ");
...
<% while (res.next()) { %>
		<div id="templatemo_header">
			<div id="templatemo_special_offers">
				<p>
					<span>25%</span> discounts for purchase over $ <%= res.getInt(5)%>
				</p>
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
				...
				<h1>
					<%=res.getString(2)%> <span>(by author name)</span>
				</h1>
				<div class="image_panel">
					<img src="<%=res.getString(3)%>"
					alt="css template ad" 
				...
				<p> <a href="http://localhost:8083/store/panier1?id=<%=res.getInt(1)%>">ajouter au panier</a> </p>
